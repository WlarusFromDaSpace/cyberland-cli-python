...
ansipost(path to file, number you're replying to(default=None), website(Doesn't appear to work with landcyber)) //Converts an imagefile to ANSI and posts it to /i/. Smaller images, like 50x50, are preferred. Size limit is 100000 bytes.
